...
export const housePointsSpread = {
    ...
    datasets: [
      {
        ...
        data: [12, 19, 3, 5, 50],
        backgroundColor: [
            'rgba(255, 180, 100, 0.86)', 
            'rgba(255, 140, 40, 0.91)', 
            'rgba(255, 120, 10, 0.7)', 
            'rgba(200, 90, 0, 0.7)', 
            'rgba(120, 50, 0, 0.7)',
          ],
    ...
    datasets: [
      {
        ...
        backgroundColor: [
            'rgba(255, 160, 60, 0.94)',
            'rgba(245, 130, 40, 0.89)', 
            'rgba(230, 100, 30, 0.84)', 
            'rgba(200, 80, 20, 0.79)', 
            'rgba(160, 60, 15, 0.74)', 
            'rgba(120, 40, 10, 0.7)',
          ],
  ...
  export default function Home() {
    ...
    return (
        <div className="bg-orange-200 grid place-items-center font-stretch-150% font-mono font-bold text-3xl"> {/* Changing the hight of it, most likely will do this later when adding the different componets and not here*/}
<div>
