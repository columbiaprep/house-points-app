...
export const housePointsSpread = {
  ...
  export default function Home() {
    ...
    return (
        <div className="bg-pink-200 grid place-items-center font-stretch-150% font-mono font-bold text-3xl"> {/* Changing the hight of it, most likely will do this later when adding the different componets and not here*/}
<div>
